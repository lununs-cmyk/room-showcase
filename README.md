...
## v7.0.5 UI polish
- 전체 16:9 레이아웃의 버튼/텍스트/여백/프레임 비율을 통일했습니다.
- 관리자 실시간 미리보기를 강제 16:9 캔버스로 정리했습니다.
- 카메라 viewport 고정 수정은 유지하면서 내부 밀도를 다듬었습니다.
- 테마 색 대비와 테두리 강도를 형식별 디자인을 해치지 않는 수준으로 조정했습니다.
