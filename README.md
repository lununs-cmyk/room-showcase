...
- 하트 폭발형: 이미지 클릭 위치 하트 파티클, 자동 하트, 이미지 전환, 원본 저장
...
## v7.0.4
- 카메라형의 과거 450x780/800px 고정 높이와 중앙 정렬 영향을 최종 차단했습니다.
- 공개 iframe에서 카메라를 viewport에 absolute/fixed로 고정하여 위쪽 빈 공간 없이 즉시 프레임을 채웁니다.
- 관리자 실시간 미리보기도 동일한 좌표 체계로 맞췄습니다.
