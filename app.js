...
let captured=false,idx=0;const root=document.querySelector('#cameraApp'),image=document.querySelector('#cameraImage'),flash=document.querySelector('.soop-flash'),look=document.querySelector('.capture-look'),stickers=document.querySelector('.sticker-layer'),meta=document.querySelector('.capture-meta'),actions=document.querySelector('#captureActions'),shutter=document.querySelector('#shutter'),sound=new Audio('https://t1.daumcdn.net/cfile/tistory/9945893F5FCA7D1B01'),counter=document.querySelector('#camCounter'),thumb=document.querySelector('#thumb');
